...
k případné kontrole. Hra skončí po určení správné 
kombinace, nebo po vypotřebování všech pokusů. %\hyperref[Ridici_elektronika]{Řídicí} %\ref{Ridici_elektronika} 
...
\begin{itemize}
  ...
  Napájecí napětí tohoto mikrokontroléru je 3,0--3,6~V~a průměrný odběr proudu je 80~mA \cite{PICO_datasheet}. ESP32-PICO má vyvedeno 
  ...
  DPS nepodporuje funkci Quick Charge ani Power Delivery. DPS může být napájena pouze napětím 5 V. Přítomnost jiného napětí není žádoucí. 
 ...
 Čip CP2102 má napájecí napětí 3--3,6 V a jeho typickým odběrem proudu je 9,5 mA.
  ...
  Pokud jsou obě zařízení v klidu (nekomunikují), tak je tranzistor zavřený a pull-up rezistory zajišťují, že na pinu mikrokontroléru
  ...
  Inteligentní LED WS2812C mají spotřebu 0,3~mA ve vypnutém stavu. I takto nízká spotřeba je  pro přenosnou aplikaci nežádoucí. Připojení
  ...
  na RS-232 a~ESP332-PICO. USB konektory musely být umístěny na okraj DPS. Proto byly jednotlivé části obvodu naskládány podél levého okraje DPS.
  ...
  jsou vedeny vedle sebe a~blízko u~sebe. Po celou jejich délku se nepřibližují ani neoddalují. Zkřížení probíhá až těsně před vstupem do %...
  ...
  firma JLCPCB dlouhodobě na skladě a nebylo možné čekat, než jej budou znovu osazovat. Z tohoto důvodu byl na finální DPS objednán tento čip 
  externě a poté doosazen ručně. Za klasických okolností by byl ale i tento čip osazen firmou JLCPCB.
  ...
  při plném nabití až 4,2~V. Kapacita jedné baterie je 2850~mAh \cite{18650}. Byly použity 2~články baterií, které byly spojeny paralelně. 
  Paralelním zapojením byla celková kapacita zdvojnásobena.
  ...
  Pokud nesvítila ani červená ani zelená LED, znamenalo to, že baterie jsou podvybité, nebo nejsou vloženy, a~nebo je příliš vysoká, 
  nebo nízká jejich teplota \cite{TP4056_datasheet}.

  Rezistorem R13 se určuvol nabíjecí proud baterií \cite{TP4056_datasheet}. Aby baterie nabíjením nebyly poškozovány, měl by být nabíjecí 
  ...
  špatně zapojeny, a~proto byly odstraněny a~nahrazeny zkratem. Jejich zapojení této komunikaci bránilo. Do další verze byly překreseny správně.
  ...
  Po veškerých opravách byla DPS plně funkční připravena na testování softwaru Elektronické hry Logic.
  ...
  Zároveň mohly být přidány drobnosti, např. v podobě přepínačů, k DPS a objednána finální verze.
