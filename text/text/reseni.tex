...
\begin{itemize}
  ...
  paměti, ze které se mikrokontrolér ESP32-PICO načítá. Při resetu musí být tyto piny ve správné konfiguraci. Z~důvodu dalších využitelných pinů
  nebyly tyto piny využity pro připojení zařízení.
  ...
  \begin{figure}[!h]
    ...
    \end{center}
    \caption[Pouzdro na baterie 18650 \cite{18650_pouzdro}]{Pouzdro na baterie 18650 \cite{18650_pouzdro}.}
  \end{figure}
...
\end{table}
  ...
  Inteligentní LED WS2812C mají spotřebu 0,3~mA, i~když zrovna nesvítí žádnou barvou. Proto je herní pole dohromady
  s~vyhodnocovacími LED rozděleno na 3~části. Do první části patří inteligentní LED se zadáním a~první 4~čtveřice inteligentních LED 
  ...
  danou oblast potřebuje. K~zapínání dochází softwarově spínáním GPIO pinu řídicího mikrokontroléru ESP32-PICO.
  ...
  Napájení inteligentních LED nelze spínat pouze jedním tranzistorem, protože logická~1~mikrokontroléru ESP32-PICO má hodnotu 3,3~V, ale je 
  ...
  Nejprve byly na DPS rozloženy inteligentní LED. Jejich rozmístění je důležité, pro zachování podobnosti deskové hře. Zároveň 
  ...
  Dráhy s~napájecím napětím by měly být vedeny co nejvíce zpříma. Proto musely být součástky se stejným napájecím napětím sdruženy u~sebe. 
  ...
  Tato verze hry je navržena jako hra pro jednoho hráče. Funkci druhého hráče nahrazuje řídicí mikrokontrolér ESP32-PICO.
  ...
  \begin{figure}[!h]
    \begin{center}
      \includegraphics[scale=0.45]{obrazky/vyvojovy_diagram.png}
    \end{center}
